        ...
        <asp:View ID="View2" runat="server">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        &nbsp;&nbsp;<asp:TextBox ID="t_type_desc" name="txtFacultyName" runat="server" BorderStyle="Solid"
                            BorderWidth="1"></asp:TextBox>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                            ErrorMessage="*This Field is required" ControlToValidate="t_type_desc" 
                ...
                <tr>
                    ...
                    <td class="style1">
                        &nbsp;&nbsp;&nbsp;<asp:Button ID="Button1" runat="server" Text="Save" Width="100px"
                            CssClass="btn btn-primary btn-large" Font-Bold="True" OnClick="btnSave_Click" ValidationGroup="insert" />&nbsp;
